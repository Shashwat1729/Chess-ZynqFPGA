...
HD_PWD='D:/Downloads/FPGA/chess_project/chess_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chess_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chess_top.tcl -notrace
